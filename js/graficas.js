...
function graficaAsunto(datos){
    ...
    const servidor = {
        ...
        data:[
            ...
            datos['junio6'], datos['julio6'], datos['agosto6'], datos['septiembre6'], datos['octubre6'],
            datos['noviembre6'], datos['diciembre6'],
        ]
    };
    ...
    const solicitud = {
        ...
        data:[
            ...
            datos['junio7'], datos['julio7'], datos['agosto7'], datos['septiembre7'], datos['octubre7'],
            datos['noviembre7'], datos['diciembre7'],
        ]
    };
    ...
    const otro = {
        ...
        data:[
            ...
            datos['junio8'], datos['julio8'], datos['agosto8'], datos['septiembre8'], datos['octubre8'],
            datos['noviembre8'], datos['diciembre8'],
        ]
    };
